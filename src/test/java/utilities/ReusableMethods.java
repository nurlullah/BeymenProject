...
//   waitFor(5);  => waits for 5 second
    ...
    public static void selectRandomProduct(List<WebElement>list){
    ...
    public static void selectRandomSize(List<WebElement>list){
        WebElement size;
        ...
        }while(size.getAttribute("class").contains("disabled"));
